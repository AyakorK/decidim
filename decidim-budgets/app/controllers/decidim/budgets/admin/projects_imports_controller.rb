...
module Decidim
  module Budgets
    module Admin
      class ProjectsImportsController < Decidim::Budgets::Admin::ApplicationController
        ...
        def new
          ...
          @form = form(Decidim::Budgets::Admin::ProjectsImportForm).instance
        end

        def create
          enforce_permission_to :import, :projects

          @form = form(Decidim::Budgets::Admin::ProjectsImportForm).from_params(params, budget:)
